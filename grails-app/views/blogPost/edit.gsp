...
<html>
	...
	<body>
		...
		<div id="edit-blogPost" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${blogPostInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${blogPostInstance}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			<g:form method="post" >
				<g:hiddenField name="id" value="${blogPostInstance?.id}" />
				<g:hiddenField name="version" value="${blogPostInstance?.version}" />
				<fieldset class="form">
