<div class="blog-div">
	<div class="blog-inner-div">
		...
		<div class="blog-content-container-div"><div class="blog-avatar-div"><img width="200px" width="200px" src="${createLink(controller: "avatar", action: "get", id: post.owner.avatar?.id)}" /></div><div class="blog-content-div"><g:contentPreview shortenTo="100"><markdown:renderHtml>${post.content}</markdown:renderHtml></g:contentPreview></div></div>
	</div>
