<div class="blog-div">
	<div class="blog-inner-div">
		...
		<div class="blog-content-div"><g:contentPreview shortenTo="100">${post.content}</g:contentPreview></div>
	</div>
	<div class="blog-replies-div">
		...
		<g:each in="${replies}" var="reply">
			<div class="blog-reply-div">
				...
				<div class="blog-content-div"><g:contentPreview shortenTo="100">${reply.content}</g:contentPreview></div>
			</div>
		</g:each>
		<g:if test="${omitted > 0}">
